...
AddModel({
	...
	Layers: ToLayerMap([
		...
		{ Name: "MouthEmbarrassed", Layer: "Hood", Pri: -9.9,
			NoOverride: true,
			HidePoses: {Xray: true},
			TieToLayer: "Mask",
		},
		{ Name: "BlushMedium", Layer: "Hood", Pri: -9.9,
			NoOverride: true,
			HidePoses: {Xray: true},
			TieToLayer: "Mask",
		},
...
AddModel(GetModelFashionVersion("KiguMaskEmbarrassed", true));
